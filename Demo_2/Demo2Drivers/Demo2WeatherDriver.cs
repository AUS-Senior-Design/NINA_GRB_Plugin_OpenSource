...
namespace Sd.NINA.Demo2.Demo2Drivers {
    ...
    /// </summary>
    public class Demo2WeatherDriver : BaseINPC, IWeatherData {
        public Demo2WeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"Demo2 Weather Data ({deviceId})";
        ...
        public string Category => "Demo2 Weather Driver";
