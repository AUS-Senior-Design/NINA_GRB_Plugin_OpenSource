...
namespace Sd.NINA.Demo2.Demo2TestCategory {
    ...
    [ExportMetadata("Category", "Demo_2")]
    [Export(typeof(ISequenceCondition))]
    [JsonObject(MemberSerialization.OptIn)]
    public class Demo2Condition : SequenceCondition {
        /// <summary>
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(Demo2Condition)}, IsTruthy: {IsTruthy}";
        }
    }
}